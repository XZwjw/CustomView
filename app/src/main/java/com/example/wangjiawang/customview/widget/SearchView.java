...
public class SearchView extends View {
    ...
    //数值动画(用于控制动画状态，因为同一时间只允许一种状态出现，具体数值处理取决于当前状态)
    private float mAnimatorValue = 0;

    //动效过程监听器
    private ValueAnimator.AnimatorUpdateListener mUpdaterListener;
    ...
    private void initAnimator() {
        ...
        mStartingAnimator.addUpdateListener(mUpdaterListener);
        mSearchingAnimator.addUpdateListener(mUpdaterListener);
        mEndingAnimator.addUpdateListener(mUpdaterListener);
    ...
    private void initListener() {
        mUpdaterListener = new ValueAnimator.AnimatorUpdateListener() {
            @Override
